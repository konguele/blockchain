...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 21 08:22:51 2022
...
app.config['JSONIFY PRETTYPRINT_REGULAR'] = False
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = "Juanjo García", amount = 10)
...
def add_transaction():
    ...
    response = {'message': 'La transacción será añadida al bloque {index}'}
    return jsonify(response), 201

# 3- Descentralizar la cadena de bloques
